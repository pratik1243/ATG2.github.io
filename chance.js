...
document.getElementById('section2').children[6].style.backgroundImage="url('interior.jpg')";
...
document.getElementById('section2').children[6].style.backgroundImage="none";
